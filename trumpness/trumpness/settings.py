"""
Django settings for trumpness project.
...
SECRET_KEY = '(^eee_q&eha_t1anh4#s14urpgnz=o2gn-(yrn@7phql2!-p4%'
...
WSGI_APPLICATION = 'trumpness.wsgi.application'
